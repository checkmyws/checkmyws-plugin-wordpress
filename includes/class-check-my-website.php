...
class Check_my_Website {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-check-my-website-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-check-my-website-i18n.php';

		/**
                 * The class responsible for defining all actions that occur with the api.
                 */
                require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-check-my-website-api.php';

		/**
		 * The class responsible for defining all actions that occur in the Dashboard.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-check-my-website-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-check-my-website-public.php';

		/**
                 * The class responsible for defining all actions that occur in the widget
                 * side of the site.
                 */
                require_once plugin_dir_path( dirname( __FILE__ ) ) . 'widget/class-check-my-website-widget.php';
